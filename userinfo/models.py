...
class Product(models.Model):
    ...
    vegan_option=models.CharField(max_length=50,default="")
    specific=models.CharField(max_length=100,default="",blank=True,null=True)
    primary_type=models.CharField(max_length=50,default="")
    secondary_type=models.CharField(max_length=50,default="")
    product_category=models.CharField(max_length=50,default="",blank=True,null=True)
    cooking_type=models.CharField(max_length=50,default="")
    product_image=models.ImageField(upload_to="product_image/%Y/%m/%d",default='DEFAULT.jpg',blank=True,null=True)
